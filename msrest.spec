...
Source0  : https://files.pythonhosted.org/packages/66/8a/e00fb779509277698c15174844fef569e706b00681b3b022ee4d87d38814/msrest-0.6.18.tar.gz
...
%prep
%setup -q -n msrest-0.6.18
cd %{_builddir}/msrest-0.6.18
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1595960265
