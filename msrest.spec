...
Source0  : https://files.pythonhosted.org/packages/f6/0d/bc78f3d63a4d202d64ee8c706af4d84b5716a8052a7e1e79aed1915c49d5/msrest-0.6.13.tar.gz
...
%prep
%setup -q -n msrest-0.6.13
cd %{_builddir}/msrest-0.6.13
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1588304360
