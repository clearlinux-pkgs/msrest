...
Source0  : https://files.pythonhosted.org/packages/32/5d/d42d519a3943247e65ba48f6fef4c4ace6f336b003c47b14f2b4b6d198c0/msrest-0.6.14.tar.gz
...
%prep
%setup -q -n msrest-0.6.14
cd %{_builddir}/msrest-0.6.14
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1589909439
